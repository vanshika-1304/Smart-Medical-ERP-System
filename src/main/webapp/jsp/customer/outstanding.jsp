...
<%@ include file="/jsp/includes/navbar.jsp" %>
  <div class="topbar">
    <div class="topbar-title">Customer Outstanding Aging</div>
      ...
      <div class="table-wrap">
        <table>
          <thead><tr>
            ...
            <th style="background:#dcfce7;color:var(--success);">0-30 Days</th>
            <th style="background:#fef9c3;color:#92400e;">31-60 Days</th>
            <th style="background:#fee2e2;color:var(--danger);">61-90 Days</th>
            <th style="background:#fecaca;color:#991b1b;">90+ Days</th>
          ...
          <tbody>
            <c:forEach var="row" items="${aging}">
              <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/customers/ledger?id=${row.customerId}" class="btn btn-sm btn-icon">Ledger</a></td>
              </tr>
            </c:forEach>
